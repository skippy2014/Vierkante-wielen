...
<div class="info-rijschool"> <h2 style="padding-top:10px;"> Informatie rijschool</h2>
  <br>
...
<div class="Over-ons"><h2>Over ons</h2>
<p>Het is onze passie om mensen te helpen bij het leren rijden. We zijn trots op onze duidelijke uitleg,
   professionele begeleiding en de steun die we kunnen geven aan mensen met een fysieke beperking,
   waarmee we onze studenten in staat stellen om snel en zelfverzekerd
de weg op te gaan. 
We willen onze studenten niet alleen helpen om hun rijbewijs te halen, maar ook om hun 
onafhankelijkheid en vrijheid te vergroten. We zijn er trots op dat we een verschil kunnen maken in het leven 
van anderen.</p> </div>

<div class="tarieven"><h2> tarieven</h2></div>

<div class="Info-Rijschoolhouder"><h2>Informatie Rijschoolhouder</h2></div>

<div class="Call-to-action"><h2>Schrijf je nu in!</h2></div>
