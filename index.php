  ...
  <body>
    ...
    <div class="headerImage">
      ...
      <div class="info-container1">
        <h2>Rijschool de Vierkante wielen</h2>
        <br>
    ...
    <div class="info-rijschool">
      ...
      <p>Onze rijschool is gericht op klanten met een fysieke beperking en we zijn er trots op <br> dat we onze
        ...
        zijn <br>er om onze studenten te ondersteunen en te begeleiden op hun reis naar het behalen van hun rijbewijs.
        <br><br>
        ...
        kunnen richten op het leren rijden.
      </p>
    </div>
    ...
    <div class="registration">
      ...
      <div class="regItem3">
        <ul class="pros">
          <li>We hebben de beste instructeurs</li>
          <li>Lessen in een automaat of schakelauto</li>
          <li>Extra begeleiding voor mensen met een fysieke beperking</li>
          <li>Rustig en doelgericht</li>
        </ul>
      </div>
    </div>
    ...
    <div class="Info-Rijschoolhouder">
      ...
      <div class="infoR2">
        <h2>Informatie Rijschoolhouder</h2>
      </div>
      <div class="infoR3">
        <p> Onze rijschoolhouder is een ervaren en professionele instructeur die zijn leerlingen
          op een vriendelijke en ondersteunende manier begeleidt. Hij is gepassioneerd over het helpen van leerlingen
          om hun rijvaardigheid te verbeteren en hen te ondersteunen bij het behalen van hun rijbewijs. </p>
      </div>
    ...
    <div class="Call-to-action">
      ...
      <div class="callA3">
        <p>Kies onze rijschool voor professionele instructeurs, betaalbare lessen en een veilige
